...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Cadastrar Calebes</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
    ...
    <div class="col-lg-12">
        <div class="box dark">
            <div id="div-1" class="accordion-body collapse in body">
                    ...
                    <div class="step1">
                        <form id="formCalebe" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-2">
                                    <input type="number" id="TIME_STUDY" name="TIME_STUDY" min="1930" max="2015" placeholder="YYYY" class="form-control" required/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-5">
                                    <div class="checkbox">
                                        <label>
                                            <input class="uniform" type="radio" name="BAPTISM" value="1" required /> Sim
                                        </label>
                                        <label>
                                            <input class="uniform" type="radio" name="BAPTISM" value="0" /> Não
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-5">
                                    <select name="ID_RELIGION" id="ID_RELIGION_C" class="form-control" required>
                                        ...
                                        if(Religion::getReligions()){
                                            ...
                                            echo '<script>
                                                        alert("Para cadastrar um Calebe é necessário ter ao menos uma Religião!");
                            ...
                            <div class="form-group lider" style="display: none">
                                <label for="pass1" class="control-label col-lg-4">Será Líder</label>

                                <div class="col-lg-5">
                                    <div class="checkbox">
                                        <label>
                                            <input class="uniform" type="radio" name="LEADER" value="2" /> Sim
                                        </label>
                                        <label>
                                            <input class="uniform" type="radio" name="LEADER" value="1" id="N" checked="checked" /> Não
                                        </label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="step2" style="display: none;">
                        <form id="formCalebeEnd" class="form-horizontal">
                            <div class="form-group">
                    ...
                    <div class="step3" style="display: none;">
                        <form id="formCalebeLogin" class="form-horizontal">
                            <div class="form-group">
                ...
                <div class="step4 col-md-offset-3 col-md-6" style="text-align: center; display: none;">
                    <h2 class="alert alert-success">O Calebe foi cadastrado com sucesso! <br> </h2>
